  ...
  const navBarMenu = (
    <>
      ...
      <li className="dropdown dropdown-hover dropdown-end">
        <label
          tabIndex="0"
          className="btn  btn-outline btn-primary text-white rounded-lg-lg"
        >
          Book Now
        </label>
        <ul
          tabIndex="0"
          className="dropdown-content menu p-2 shadow bg-base-100 rounded-lg-box w-52"
        >
          <li>
            <Link to="/">Item 1</Link>
          </li>
  ...
  return (
    <div className="drawer  drawer-end">
      ...
      <div className="drawer-content flex flex-col">
        <div className="w-full navbar lg:px-20 md:px-10 bg-base-100 fixed top-0">
          <div className="flex-1 px-2 mx-2 font-bold text-xl">
            <Link to="/">Clean Co.</Link>
          </div>
          <div className="flex-none hidden lg:block">
            <ul className="menu menu-horizontal gap-x-1">{navBarMenu}</ul>
          </div>
